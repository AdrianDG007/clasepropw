// Ejercicio de Duración total de álbumes de rock
...
let duracionTotalRock = 0;

for (let i = 0; i < albums.length; i ++) {
  if (albums [i].genre === "Rock") {
    duracionTotalRock = duracionTotalRock + albums [i].duration;
  }
}

console.log ("Duración total de álbumes de rock:", duracionTotalRock.toFixed (2), "minutos");