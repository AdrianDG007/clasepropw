...
// 7.concat(): Retorna un nuevo array que es la combinación de dos o más arrays.
let array2 = ['x', 'y', 'z'];
...
// 10.map(): Crea un nuevo array con los resultados de la llamada a una función dada en acada elemento del array.
let nuevoArray = array.map((elemento) => elemento * 2);

// 11.filter(): Crea un nuevo array con todos los elementos que cumplan la condición dada.
let arrayFiltrado = array.filter((elemento) => elemento > 3);

// 12.reduce(): Aplica una función a un acumulador y a cada valor de un array (de izquierda a derecha) para reducirlo a un solo valor.
...
//15.reserve(): Invierte el oredn de los elemento de un array in-place
array.reverse();