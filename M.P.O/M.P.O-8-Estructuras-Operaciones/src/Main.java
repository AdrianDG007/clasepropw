...
public class Main {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("4 añadir interactivo");
            System.out.println("Indica que opcion quieres hacer ");
            opcion = scanner.nextInt();
            switch (opcion) {
                case 1 -> {
                    System.out.println("Dime el correo que quires añadir");
                   ...
                   if (controller.metodoAnadir(correo)){
                       ...
                       System.out.println("El usuario no se a podido agregar");

                   }
                    // en caso de añadirlo1 te digo que "agregado correctamente"
                ...
                case 4 -> {
                    // no quiere que puedan existir repeteidos
