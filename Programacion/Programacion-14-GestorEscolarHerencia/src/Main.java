...
public class Main {
    ...
    public static void main (String [] args) {
        ...
        System.out.println ("Bienvenido al gestor scolar");
        /*Fijo fijo1 = new Fijo ("Profesor1","Apellido1",10000,3000,30);
        Fijo fijo2 = new Fijo ("Profesor2","Apellido2",20000);
        Interno interno = new Interno ("ProfesorInterno1","ApelliidoInterno2",4000,1,1);
        interno.realizarOposion ();
        interno.mostrarDatos ();*/
        Fijo fijo2 = new Fijo ("Profesor2","Apelldio", 20000);
        // fijo2.realizarInspeccion (3);
        Interno interno = new Interno("ProfesorInterno1","ApellidoInterno2",4000, 1,1 );
        // interno.mostrarDatos();
        Director director = new Director("Director", "Apelldio1");
